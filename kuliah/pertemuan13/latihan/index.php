        ...
        <tbody>
            <?php $no = 1; foreach($mahasiswa as $mhs) { ?>
              <tr>
                ...
                <td>
                  <a href="ubah.php?id=<?php echo $mhs["id"]; ?>" class="btn btn-sm text-white bg-warning">Ubah</a>
                  <a href="hapus.php?id=<?php echo $mhs["id"]; ?>" onclick="return confirm('Hapus data?');" class="btn btn-sm text-white bg-danger">Hapus</a>
                </td>
              </tr>
              <?php } ?>
        </tbody>
